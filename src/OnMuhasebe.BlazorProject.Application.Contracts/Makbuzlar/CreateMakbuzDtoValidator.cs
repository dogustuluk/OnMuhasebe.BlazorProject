...
{
    public CreateMakbuzDtoValidator(IStringLocalizer<BlazorProjectResource> localizer)
    {
        RuleFor(x => x.MakbuzTuru)
           .IsInEnum()
           .WithMessage(localizer[BlazorProjectDomainErrorCodes.Required, localizer["ReceiptType"]])
