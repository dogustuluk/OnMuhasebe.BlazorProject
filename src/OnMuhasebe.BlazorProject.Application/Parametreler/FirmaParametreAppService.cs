...
public class FirmaParametreAppService : BlazorProjectAppService, IFirmaParametreAppService
{
    ...
    [NonAction]
    public virtual Task<PagedResultDto<SelectFirmaParametreDto>> GetListAsync(FirmaParametreListParameterDto input)
    {
