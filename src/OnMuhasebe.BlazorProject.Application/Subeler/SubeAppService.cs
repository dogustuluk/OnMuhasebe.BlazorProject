...
public class SubeAppService : BlazorProjectAppService, ISubeAppService
{
    ...
    {
        var entities = await _subeRepository.GetPagedListAsync(input.SkipCount, input.MaxResultCount, x => x.Durum == input.Durum, x => x.Kod);
