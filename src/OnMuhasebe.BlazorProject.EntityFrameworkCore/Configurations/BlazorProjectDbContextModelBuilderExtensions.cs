...
public static class BlazorProjectDbContextModelBuilderExtensions
{
    ...
    public static void ConfigureBankaSube(this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(BlazorProjectConsts.DbTablePrefix + "BankaSubeler", BlazorProjectConsts.DbSchema);//blazorProjectConst ile oluşturulan tablonun önünde hangi string değerin geleceğini belirtir. burada App olarak verilmiş, isteğe bağlı olarak o sınıftan bu isim değiştirilebilir.
            b.ConfigureByConvention();
