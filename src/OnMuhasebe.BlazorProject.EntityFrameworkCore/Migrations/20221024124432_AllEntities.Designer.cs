...
{
    [DbContext(typeof(BlazorProjectDbContext))]
    [Migration("20221024124432_AllEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.BankaHesaplar.BankaHesap", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Bankalar.Banka", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.BankaSubeler.BankaSube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Birimler.Birim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Cariler.Cari", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Depolar.Depo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Donemler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Faturalar.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Faturalar.FaturaHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Hizmetler.Hizmet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Kasalar.Kasa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Makbuzlar.Makbuz", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Makbuzlar.MakbuzHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Masraflar.Masraf", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.OzelKodlar.OzelKod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Parametreler.FirmaParametre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Stoklar.Stok", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Subeler.Sube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.BankaHesaplar.BankaHesap", b =>
                {
                    b.HasOne("OnMuhasebe.BlazorProject.BankaSubeler.BankaSube", "BankaSube")
                        .WithMany("BankaHesaplar")
                        .HasForeignKey("BankaSubeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnMuhasebe.BlazorProject.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1BankaHesaplar")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OnMuhasebe.BlazorProject.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2BankaHesaplar")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OnMuhasebe.BlazorProject.Subeler.Sube", "Sube")
                        .WithMany("BankaHesaplar")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.BankaSubeler.BankaSube", b =>
                {
                    b.HasOne("OnMuhasebe.BlazorProject.Bankalar.Banka", "Banka")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Faturalar.Fatura", b =>
                {
                    b.HasOne("OnMuhasebe.BlazorProject.Cariler.Cari", "Cari")
                        .WithMany("Faturalar")
                        .HasForeignKey("CariId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OnMuhasebe.BlazorProject.Donemler.Donem", "Donem")
                        .WithMany("Faturalar")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Faturalar.FaturaHareket", b =>
                {
                    b.HasOne("OnMuhasebe.BlazorProject.Depolar.Depo", "Depo")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("DepoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OnMuhasebe.BlazorProject.Faturalar.Fatura", "Fatura")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("FaturaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnMuhasebe.BlazorProject.Hizmetler.Hizmet", "Hizmet")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OnMuhasebe.BlazorProject.Masraflar.Masraf", "Masraf")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("MasrafId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OnMuhasebe.BlazorProject.Stoklar.Stok", "Stok")
                        .WithMany("FaturaHareketler")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Hizmetler.Hizmet", b =>
                {
                    b.HasOne("OnMuhasebe.BlazorProject.Birimler.Birim", "Birim")
                        .WithMany("Hizmetler")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Makbuzlar.Makbuz", b =>
                {
                    b.HasOne("OnMuhasebe.BlazorProject.BankaHesaplar.BankaHesap", "BankaHesap")
                        .WithMany("Makbuzlar")
                    ...
                    b.HasOne("OnMuhasebe.BlazorProject.Kasalar.Kasa", "Kasa")
                        .WithMany("Makbuzlar")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Makbuzlar.MakbuzHareket", b =>
                {
                    ...
                    b.HasOne("OnMuhasebe.BlazorProject.Bankalar.Banka", "CekBanka")
                        .WithMany("MakbuzHareketler")
                        .HasForeignKey("CekBankaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("OnMuhasebe.BlazorProject.BankaSubeler.BankaSube", "CekBankaSube")
                        .WithMany("MakbuzHareketler")
                    ...
                    b.HasOne("OnMuhasebe.BlazorProject.Makbuzlar.Makbuz", "Makbuz")
                        .WithMany("MakbuzHareketler")
            ...
            modelBuilder.Entity("OnMuhasebe.BlazorProject.Parametreler.FirmaParametre", b =>
                {
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("OnMuhasebe.BlazorProject.Parametreler.FirmaParametre", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
